  ...
  <div style="max-width:600px;margin:0 auto;background:#111;border:1px solid rgba(255,98,0,0.3)">
    ...
    <div style="padding:32px">
      <table style="width:100%;border-collapse:collapse">
        <tr><td style="padding:10px 0;color:#888;width:140px">From</td><td style="padding:10px 0;color:#f5f5f5"><strong>${name}</strong></td></tr>
        <tr><td style="padding:10px 0;color:#888">Email / Phone</td><td style="padding:10px 0;color:#FF6200">${contact}</td></tr>
      </table>
      <div style="margin-top:24px">
        <div style="font-size:.75rem;letter-spacing:4px;text-transform:uppercase;color:#FF6200;margin-bottom:10px">Message</div>
        <div style="background:#181818;border-left:3px solid #FF6200;padding:16px;color:#f5f5f5;line-height:1.7">${message}</div>
      </div>
    </div>
...
<body style="margin:0;padding:0;background:#0A0A0A;font-family:Arial,sans-serif">
  <div style="max-width:600px;margin:0 auto;background:#111;border:1px solid rgba(255,98,0,0.3)">
    ...
    <div style="padding:32px">
      <table style="width:100%;border-collapse:collapse">
        <tr><td style="padding:10px 0;color:#888;width:160px">Customer</td><td style="padding:10px 0;color:#f5f5f5"><strong>${name}</strong></td></tr>
        <tr><td style="padding:10px 0;color:#888">Email / Phone</td><td style="padding:10px 0;color:#FF6200">${contact}</td></tr>
        <tr><td style="padding:10px 0;color:#888">Product Type</td><td style="padding:10px 0;color:#f5f5f5">${productType || '—'}</td></tr>
        <tr><td style="padding:10px 0;color:#888">Colour</td><td style="padding:10px 0;color:#f5f5f5">${colour || '—'}</td></tr>
      </table>
      <div style="margin-top:24px">
        <div style="font-size:.75rem;letter-spacing:4px;text-transform:uppercase;color:#FF6200;margin-bottom:10px">Their Idea</div>
        <div style="background:#181818;border-left:3px solid #FF6200;padding:16px;color:#f5f5f5;line-height:1.7">${idea || '—'}</div>
      </div>
    </div>
    <div style="padding:16px 32px;border-top:1px solid #222;text-align:center">
      <p style="margin:0;color:#555;font-size:.8rem">Crank Theory &bull; cranktheory07@gmail.com</p>
