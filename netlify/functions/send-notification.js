...
exports.handler = async (event) => {
  ...
  const shippingAddress = `${addr1}${addr2 ? ', ' + addr2 : ''}, ${city}, ${state} - ${pin}`;
...
<body style="margin:0;padding:0;background:#0A0A0A;font-family:'Arial',sans-serif">
  <div style="max-width:600px;margin:0 auto;background:#111;border:1px solid rgba(255,98,0,0.3)">
    ...
    <!-- Alert Banner -->
    <div style="background:#181818;padding:20px 32px;border-bottom:1px solid #222;text-align:center">
      <p style="margin:0;font-size:1.1rem;color:#f5f5f5">&#128293; <strong style="color:#FF6200">New order placed</strong> on your store!</p>
    </div>
    ...
    <div style="padding:24px 32px;border-bottom:1px solid #222">
      ...
      <table style="width:100%;border-collapse:collapse">
        <tr><td style="padding:6px 0;color:#888;font-size:.85rem">Payment ID</td><td style="padding:6px 0;color:#f5f5f5;font-size:.85rem;text-align:right"><strong>${payment_id}</strong></td></tr>
        <tr><td style="padding:6px 0;color:#888;font-size:.85rem">Order ID</td><td style="padding:6px 0;color:#f5f5f5;font-size:.85rem;text-align:right">${order_id}</td></tr>
    ...
    <div style="padding:24px 32px;border-bottom:1px solid #222">
      ...
      <table style="width:100%;border-collapse:collapse">
        <tr><td style="padding:6px 0;color:#888;font-size:.85rem">Name</td><td style="padding:6px 0;color:#f5f5f5;font-size:.85rem;text-align:right">${name}</td></tr>
        <tr><td style="padding:6px 0;color:#888;font-size:.85rem">Phone</td><td style="padding:6px 0;color:#f5f5f5;font-size:.85rem;text-align:right">${phone}</td></tr>
        <tr><td style="padding:6px 0;color:#888;font-size:.85rem">Email</td><td style="padding:6px 0;color:#f5f5f5;font-size:.85rem;text-align:right">${email}</td></tr>
      </table>
    </div>
    ...
    <div style="padding:20px 32px;text-align:center">
      <p style="margin:0;color:#555;font-size:.8rem;letter-spacing:1px">Crank Theory &bull; cranktheory07@gmail.com &bull; @cranktheory07</p>
    </div>
